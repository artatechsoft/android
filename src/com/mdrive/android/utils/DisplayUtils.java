...
public class DisplayUtils {
    ...
    private static final String OWNCLOUD_APP_NAME = "mdrive";
    ...
    private static final String SUBTYPE_EPUB_PLUS_ZIP = "epub+zip";
    ...
    public static int getResourceId(String mimetype, String filename) {
        ...
        if (mimetype == null || "DIR".equals(mimetype)) {
            ...
            if(TYPE_TXT.equals(type)) {
                ...
                } else if (SUBTYPE_EPUB_PLUS_ZIP.equals(subtype)) {
