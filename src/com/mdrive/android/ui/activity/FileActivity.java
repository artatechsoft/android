...
import com.mdrive.android.files.FileOperationsHelper;
...
import com.owncloud.android.lib.common.utils.Log_OC;import com.mdrive.android.operations.CreateShareOperation;
...
implements OnRemoteOperationListener, ComponentsGetter {
    ...
    public static final String EXTRA_FILE = "com.mdrive.android.ui.activity.FILE";
    public static final String EXTRA_ACCOUNT = "com.mdrive.android.ui.activity.ACCOUNT";
    public static final String EXTRA_WAITING_TO_PREVIEW = "com.mdrive.android.ui.activity.WAITING_TO_PREVIEW";
    public static final String EXTRA_FROM_NOTIFICATION= "com.mdrive.android.ui.activity.FROM_NOTIFICATION";
    ...
    private void swapToDefaultAccount() {
        ...
        if(newAccount==null) {
            try {
                Context context = createPackageContext("com.onyx.android.startuptutorial",0);
                SharedPreferences pref = context.getSharedPreferences("authentication_prefs", Context.MODE_PRIVATE);
