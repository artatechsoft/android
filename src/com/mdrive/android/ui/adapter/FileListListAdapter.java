...
public class FileListListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mFiles != null && mFiles.size() > position) {
            ...
            ImageView stateCloud = (ImageView) view.findViewById(R.id.imageView4);
            localStateView.bringToFront();
            FileDownloaderBinder downloaderBinder = 
                    mTransferServiceGetter.getFileDownloaderBinder();
            FileUploaderBinder uploaderBinder = mTransferServiceGetter.getFileUploaderBinder();
            if (downloaderBinder != null && downloaderBinder.isDownloading(mAccount, file)) {
                localStateView.setImageResource(R.drawable.ic_action_download);
                localStateView.setVisibility(View.VISIBLE);
            } else if (uploaderBinder != null && uploaderBinder.isUploading(mAccount, file)) {
                localStateView.setImageResource(R.drawable.ic_action_upload);
                localStateView.setVisibility(View.VISIBLE);
            } else if (file.isDown()) {
                localStateView.setVisibility(View.INVISIBLE);
                stateCloud.setVisibility(View.INVISIBLE);
                //localStateView.setImageResource(R.drawable.local_file_indicator);
                //localStateView.setVisibility(View.VISIBLE);
            } else {
                localStateView.setVisibility(View.INVISIBLE);
                stateCloud.setVisibility(View.VISIBLE);
            }
...
/*
				...
				stateCloud.setVisibility(View.INVISIBLE);                fileSizeV.setVisibility(View.INVISIBLE);
                //fileSizeV.setText(DisplayUtils.bytesToHumanReadable(file.getFileLength()));
                lastModV.setVisibility(View.VISIBLE);
                lastModV.setText(
                        DisplayUtils.unixTimeToHumanReadable(file.getModificationTimestamp())
